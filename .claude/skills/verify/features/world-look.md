...
- 12_landscape: `src/systems/12_landscape.gd`, reached by `tools/tour.sh tours/landscape.tour`; the snowfield's grid hung with ice, on a seed whose grid crosses it, by `tools/tour.sh tours/iced_line.tour` (seed 4).
