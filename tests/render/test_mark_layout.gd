...
func test_every_ground_mark_lies_in_a_ground_run() -> void:
	...
	for m: int in [GroundColors.FRESH, GroundColors.VITRIFIED, GroundColors.TIDEFLAT, GroundColors.CITY_FLOOR, GroundColors.OVERGROWN, GroundColors.CAST_FLOOR, GroundColors.MACHINE_DECK]:
...
func test_the_shader_states_the_same_layout() -> void:
	...
	for pair: Array in [["MARK_GROUND_A0", GroundColors.GROUND_A.x], ["MARK_GROUND_A1", GroundColors.GROUND_A.y],
			...
			["M_CAST_FLOOR", GroundColors.CAST_FLOOR], ["M_MACHINE_DECK", GroundColors.MACHINE_DECK],
