...
| `src/systems/` | `NN_name.gd` game systems, loaded in order: 05 save, 10 sky, 12 landscape, 15 lights, 16 vents, 20 realms, 30 mobs, 35 folk, 36 parade, 37 fauna, 40 fight, 42 target, 44 crafts, 44 sentinels, 46 settlements, 49 story, 50/52 survival, 56 economy, 70 audio, 75 music, 90 ui, 94 dev, 98 tour. |
