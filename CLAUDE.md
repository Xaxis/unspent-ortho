...
tools/tour.sh tours/saves-elsewhere.tour --saves=saves-elsewhere --seed=1 --hour=10 --weather=clear:0   # a save made on another island is named, not opened (two steps first: see the tour's header)
