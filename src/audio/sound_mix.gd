...
## Countries the listener will be in soon: a ring at `reach` tiles and one
...
static func country_soon(world: WorldData, p: Vector2, heading: Vector2, reach: float) -> Dictionary:
