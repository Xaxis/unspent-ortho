...
const SHAPES := {
	...
	&"ingot": [
		["poly", "a2", [12.0, 19.0, 28.5, 14.5, 28.5, 20.5, 12.0, 25.0]],
		["poly", "a3", [4.0, 15.0, 12.0, 19.0, 12.0, 25.0, 4.0, 21.0]],
		["poly", "a5", [4.0, 15.0, 20.0, 10.5, 28.5, 14.5, 12.0, 19.0]],
	],
	&"lump": [
	...
	&"cloth": [
		["poly", "a3", [3.0, 15.0, 29.0, 15.0, 29.0, 27.0, 3.0, 27.0]],
		["poly", "a4", [3.0, 9.0, 29.0, 9.0, 30.0, 15.0, 3.0, 15.5]],
		["line", 3.0, 21.0, 29.0, 21.0], ["line", 3.0, 12.0, 29.0, 12.0],
	],
	&"basket": [
	...
	&"dram": [
		["poly", "a3", [16.0, 3.0, 26.0, 9.0, 26.0, 23.0, 16.0, 29.0, 6.0, 23.0, 6.0, 9.0]],
		["poly", "a4", [16.0, 3.0, 26.0, 9.0, 16.0, 15.0, 6.0, 9.0]],
		["glow", 16.0, 19.0, 3.4],
	],
	&"paper": [
...
const FOUND_SHAPES: Array[StringName] = [&"glim", &"scrap", &"kit", &"dram", &"beam", &"broad", &"blade", &"hammer", &"torch", &"brace", &"rig", &"lens", &"aerial"]
