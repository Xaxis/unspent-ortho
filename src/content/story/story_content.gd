...
const BEATS := {
	...
	&"branches": {"arc": &"account", "says": "There is more than one of this place, and they do not agree with each other."},
	...
	&"quiet_calm": {"arc": &"quiet", "says": "Somewhere the machines have never once been roused, and nobody there finds that strange."},
	&"quiet_glad": {"arc": &"quiet", "says": "The people there are not afraid. They stopped disagreeing, and it rested them."},
	&"quiet_cost": {"arc": &"quiet", "says": "What it cost them was the part that could have said no. They do not miss it. That is the cost."},
	&"key_accepted": {"arc": &"key", "says": "Somebody once wrote a signature by hand, and the machines let it through."},
	&"key_price": {"arc": &"key", "says": "A key only works while nobody knows whose it is. The first one cost somebody their name."},
	&"key_carried": {"arc": &"key", "says": "The signet you wear is a copy of a copy of theirs, and it still works."},
	&"clerk_written": {"arc": &"clerk", "says": "A clerk has written you down. You felt nothing. That is how it is done."},
	&"clerk_record": {"arc": &"clerk", "says": "You have held their account of a place. It was mostly numbers, and one of them was you."},
	&"clerk_asked": {"arc": &"clerk", "says": "People have walked up to a clerk and asked to be filed. It has never once refused."},
	&"went_in_boots": {"arc": &"went_in", "says": "People walked into the works of their own accord, and left their boots at the fence."},
	&"went_in_tally": {"arc": &"went_in", "says": "The works count who goes in. Nothing in them counts who comes out."},
	&"went_in_out": {"arc": &"went_in", "says": "One came out. They will not go near the water, or say what was inside."},
	&"went_in_dark": {"arc": &"went_in", "says": "You put a works yard dark. Nobody was inside it. Nobody had been for a long time."},
}
...
const FRAGMENTS := {
	...
	&"you_are_here": {
		...
		"lines": [
			"YOU ARE HERE",
			"",
			"The red dot has been scratched off and painted back on",
			"so many times the board is a crater where it goes.",
	...
	&"two_maps": {
		...
		"lines": [
			"The same bay, drawn twice, a year apart, by the same hand.",
	...
	&"fine_diary": {
		...
		"lines": [
			...
			"  Fine.",
			"",
			"On one page, crossed out so hard the pen went through:",
			"\"I think I used to",
		],
		"beats": [&"quiet_cost"],
	},
