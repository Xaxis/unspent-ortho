...
static func _build() -> void:
	...
	mast.lands = [&"moss", &"snowfield", &"pinewood", &"slums", &"frost_sea", &"drowned_city", &"the_crags"]
	mast.wants = &"water"
	mast.sees = 13.0
	...
	tower.lands = [&"pinewood", &"coast", &"scrapwood", &"the_crags", &"sulphur_jungle", &"green_towers"]
	tower.wants = &"high"
	tower.sees = 13.0
	...
	stack.lands = [&"snowfield", &"bonelands", &"burning", &"scrapwood", &"slums", &"mesas", &"glass_desert", &"frost_sea", &"server_fields", &"grey_orchards", &"ruined_metropolis", &"machine_city", &"the_middens", &"sulphur_jungle", &"green_towers"]
	stack.wants = &"open"
	stack.sees = 13.0
	...
	stones.lands = [&"bonelands", &"moss", &"coast", &"salt_flats", &"pinewood", &"snowfield", &"mesas", &"glass_desert", &"frost_sea", &"ruined_metropolis", &"the_crags", &"machine_city"]
	stones.wants = &"high"
	stones.sees = 12.0
	...
	pans.lands = [&"salt_flats", &"burning", &"glass_desert", &"sulphur_jungle"]
	pans.wants = &"open"
	pans.sees = 12.0
	...
	hulk.lands = [&"coast", &"moss", &"pinewood", &"scrapwood", &"the_middens"]
	hulk.wants = &"open"
	hulk.sees = 13.0
	...
	office.lands = [&"bonelands", &"salt_flats", &"burning", &"snowfield", &"scrapwood", &"limestone_caves", &"moss", &"slums", &"mesas", &"server_fields", &"drowned_city", &"grey_orchards", &"ruined_metropolis", &"machine_city", &"the_middens", &"the_crags", &"sulphur_jungle", &"green_towers"]
	office.wants = &"rough"
	office.sees = 12.0
	...
	pillar.lands = [&"limestone_caves", &"mesas", &"glass_desert", &"server_fields", &"drowned_city", &"grey_orchards", &"ruined_metropolis", &"machine_city", &"the_middens", &"green_towers"]
	pillar.wants = &"rough"
	pillar.sees = 12.0
